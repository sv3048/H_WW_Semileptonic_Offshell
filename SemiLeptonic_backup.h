...
int getFatJetGenMatch(float fatjet_eta, float fatjet_phi, int nGenPart, 
                      const std::vector<float>& GenPart_eta, 
                      const std::vector<float>& GenPart_phi, 
                      const std::vector<int>& GenPart_pdgId) {
    float minDR = 0.8;
    int matchId = 0;
